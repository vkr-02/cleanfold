...
const Invoice = (props) => {
	...
	const { fullName, email, mobileNumber, road, flat, address, getDate, getTime, paymentMethod, transactionId } = singleOrder.shipment;
	...
	return (
		<div className="print-container">
			<div className="d-flex justify-content-center mb-4">
				<h2 className="text-danger head-title mt-5">Clean Fold Online Laundry Service</h2>
			</div>
			<div className="row">
				<div className="col-md-8">
					...
					<p>
						...
						{paymentMethod === 'upi' ? `UPI Payment (Txn: ${transactionId})` : 'Cash on Delivery'}
					</p>
					<p>
